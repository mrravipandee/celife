...
export function ServiceStats({ totalCount, activeCount, draftCount }: ServiceStatsProps) {
  ...
  const statsList = [
    { label: "Total Services", value: padZero(totalCount) },
    { label: "Active", value: padZero(activeCount) },
    { label: "Drafts", value: padZero(draftCount) },
  ];
